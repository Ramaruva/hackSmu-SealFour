...
const PeerSupportPage = () => {
  ...
  const availableTimes = ['10:00 AM', '11:30 AM', '1:00 PM', '3:00 PM', '5:00 PM'];
    ...
    <div className="min-h-screen bg-gray-100 py-8">
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold text-green-600">Peer Support Services</h1>
          ...
          {experts.map((expert) => (
            <div
              ...
              className={`bg-white p-6 rounded-lg shadow-md cursor-pointer hover:bg-gray-200 transition ${
                selectedExpert && selectedExpert.id === expert.id ? 'bg-green-200' : ''
              }`}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <div className="max-w-md mx-auto">
                <Calendar value={selectedDate} onChange={handleDateChange} className="w-full" />
              </div>
            </div>
              ...
              <div className="text-center">
                ...
                {isBooked && (
                  <p className="text-green-600 mt-4">
                    Your session with {selectedExpert.name} is booked for {selectedTime} on{' '}
        ...
        <div className="bg-blue-100 p-6 rounded-lg shadow-md text-center mt-12">
          <h2 className="text-3xl font-semibold text-blue-600">What Students Are Saying</h2>
          <p className="text-lg text-gray-700 mt-4 italic">
            "Peer support helped me navigate the toughest semester of my life."
          </p>
          <p className="text-lg text-gray-700 mt-2 italic">"I found a community that understands me."</p>
        </div>

        {/* Crisis Resources Section */}
        <div className="bg-yellow-100 p-6 mt-12 text-center rounded-lg shadow-md">
          <h2 className="text-2xl font-semibold text-yellow-600">Need Immediate Help?</h2>
          <p className="text-lg text-gray-700 mt-4">
            If you're in crisis, reach out to our mental health professionals or the national hotline for urgent help.
          </p>
          <p className="text-lg text-gray-700 mt-2">
            Call: <strong>+1-800-273-TALK (8255)</strong>
          </p>
          <p className="text-lg text-gray-700 mt-2">SMU Crisis Line: <strong>+1-123-456-7890</strong></p>
        </div>
      </div>
    </div>
  );
